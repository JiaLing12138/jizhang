#!/usr/bin/env node
/* 记账数据.js（Scriptable 共享模块）识别规则回归测试
 * 用法：node scripts/test_scriptable_rules.js */
const path = require('path');
const D = require(path.join(__dirname, '..', 'scriptable', '记账数据.js'));

const { extractAmount, detectCategory, isRefund, extractDate, cleanNoteLine, toAmt } = D;
